...
**June 20, 2019**. The latest [blog post]({{ site.baseurl }}/blog/digital-and-collaborative-materials/) by the website & app chair offers some thoughts on the conference website, app, and handbook.
{: .notice--info}
...
**June 10, 2019**. The [slides]({{ site.baseurl }}/downloads/naacl2019-intro-slides.pdf) from the opening session of the conference are now linked from the [schedule]({{ site.baseurl }}/schedule).
{: .notice}
...
**June 1, 2019**. The [schedule]({{ site.baseurl }}/schedule/) now links to the anthology PDFs. Look for the <i class="far fa-file-pdf"></i>&nbsp;icon!
{: .notice}

**May 28, 2019**. The official conference App is now live! Get it [here](https://whova.com/portal/naacl_201906/?source=download_page)! Click [here]({{ site.baseurl }}/participants#conference-app) to learn how to use it and how to report any issues.
{: .notice}


<div class="text-center">
    <a href="{{ site.baseurl }}/archive/" style="font-size: smaller; font-decoration: italic;">Older News</a>
</div>
